...
<head>
  ...
  <title>Login - Padoca Dona Inês</title>
...
<body class="font-sans overflow-hidden flex justify-between">
  ...
  <section class="section-login w-full lg:w-[50vw] h-screen flex flex-col justify-center px-6 sm:px-16 md:px-28">
    <div class="login-container w-full max-w-md mx-auto">
      ...
      <p class="text-zinc-400 mt-4">Estamos felizes em ter você aqui. Faça login para continuar e provar os sabores
        tradicionais que aquecem o coração.</p>
      <form method="POST" action="{{ route('login') }}">
        ...
        <aside class="aside-options flex justify-between mt-3">
          ...
          <button class="text-color-primary font-bold text-[13px] md:text-base">Esqueceu sua senha?</button>
        </aside>
      ...
      <p class="mt-4 text-center">Ainda não tem uma conta? <a href="{{ route('register') }}" class="text-color-primary font-bold">Cadastre-se</a></p>
    </div>
  </section>
</body>
